...
- Release resolution and publish workflow generation code belongs under `pkg/release`.
...
- Supported `command` input values are `version`, `help`, `changelog`, `release-resolve`, and `none`.
